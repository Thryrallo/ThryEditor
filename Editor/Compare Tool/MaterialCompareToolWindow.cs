...
public class MaterialCompareToolWindow : EditorWindow
{
    ...
    void CreateGUI()
    {
        ...
        var leftContainer = CreateContainer(out leftObjectField, out leftMaterialUi, evt => HandleMaterialChange(out leftMaterial, leftMaterialUi, evt.newValue as Material));
        var rightContainer = CreateContainer(out rightObjectField, out rightMaterialUi, evt => HandleMaterialChange(out rightMaterial, rightMaterialUi, evt.newValue as Material));
    ...
    VisualElement CreateContainer(out ObjectField objectField, out IMGUIContainer materialUi, EventCallback<ChangeEvent<UnityEngine.Object>> changeEvent)
    {
    ...
    class MaterialRepresentation
    {
        ...
        public void DrawGUI()
        {
            shaderEditor?.OnGUI(materialEditor, properties);
        }
        ...
        public MaterialRepresentation(Material material)
        {
            ...
            properties = MaterialEditor.GetMaterialProperties(new UnityEngine.Object[] { material });
        }

        public MaterialRepresentation(ShaderEditor shaderEditor, MaterialEditor materialEditor, params MaterialProperty[] properties)
        {
